...
using UmaMahesh_BackApp.Models.Products.Products;
...
namespace UmaMahesh_BackApp.Controllers;
    ...
    public async Task<IActionResult> GetAllProducts([FromQuery] ProductQueryParameters queryParameters)
    {
        try
        {  
            IQueryable<Products> products = _dataRepositoryContext.Products;
            ...
            {
                if (typeof(Products).GetProperty(queryParameters.SortBy) != null)
                {
                    products = products
                        .OrderByCustom(
    ...
    public async Task<IActionResult> GetAllProductsByColor( string color)
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddProduct(Products res)
        {
        try
        {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> EditProduct([FromRoute] int id, Products request)
    {
        try
        {
